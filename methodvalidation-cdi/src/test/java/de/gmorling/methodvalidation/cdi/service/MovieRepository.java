 ...
 */
package de.gmorling.methodvalidation.cdi.service;
...
import de.gmorling.methodvalidation.cdi.AutoValidating;
...
public class MovieRepository {
	...
	public Set<Movie> findMoviesByDirector(@NotNull @Size(min=3) String director) {
